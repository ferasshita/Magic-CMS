...
Vvveb.ComponentsGroup['Widgets'] = ["widgets/blog", "widgets/browse", "widgets/countTable", "widgets/tableView", "widgets/googlemaps", "widgets/embed-video", "widgets/chartjs",/* "widgets/facebookpage", */"widgets/paypal", /*"widgets/instagram",*/ "widgets/x", "widgets/openstreetmap"/*, "widgets/facebookcomments"*/];

Vvveb.Components.extend("_base", "widgets/blog", {
    name: "Blog",
    attributes: ["data-component-blog"],
    image: "icons/file.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/file.svg">',
    html: '<div data-component-blog><div onload></div></div>',
	...
	init: function (node)
	{
		let iframe = jQuery('div', node);
		let url = new URL(iframe.attr("onload"));
		let params = new URLSearchParams(url.search);

		this.blogtype = params.get("blogtype");

		$(".component-properties input[name=blogtype]").val(this.blogtype);
	},

    onChange: function (node, property, value) {
		map_iframe = jQuery('div', node);

		this[property.key] = value;

		mapurl = "blog_view(this,'" + this.blogtype + "')";

		map_iframe.attr("onload",mapurl);
...
Vvveb.Components.extend("_base", "widgets/countTable", {
    name: "Count Table",
    attributes: ["data-component-counttable"],
    image: "icons/panel.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/panel.svg">',
    html: '<div data-component-counttable><div onload></div></div>',
    resizable:true,//show select box resize handlers
    resizeMode:"css",
    ...
    tableName:'', //zoom
    column:'',//location
		value: '', //map type q = roadmap, w = satellite
		sid: '', //map type q = roadmap, w = satellite
	...
	init: function (node)
	{
		...
		$(".component-properties input[name=tableName]").val(this.tableName);
		$(".component-properties input[name=column]").val(this.column);
		$(".component-properties input[name=filter]").val(this.value);
		$(".component-properties input[name=sid]").val(this.sid);
	},
    ...
    onChange: function (node, property, value) {
		...
		mapurl = "count_table(this,'" + this.tableName + "','" + this.column + "','" + this.value + "','" + this.sid + "')";
...
Vvveb.Components.extend("_base", "widgets/tableView", {
    name: "Table View",
    attributes: ["data-component-m"],
    image: "icons/table.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/table.svg">',
    html: '<div data-component-m><div onload></div></div>',
    resizable:true,//show select box resize handlers
    resizeMode:"css",
    ...
    tableName:'', //zoom
    column:'',//location
		filter: '', //map type q = roadmap, w = satellite
	...
	init: function (node)
	{
		...
		$(".component-properties input[name=tableName]").val(this.tableName);
		$(".component-properties input[name=column]").val(this.column);
		$(".component-properties input[name=filter]").val(this.filter);
	},
    ...
    onChange: function (node, property, value) {
		...
		mapurl = "table_fetch(this,'" + this.tableName + "','" + this.column + "','" + this.filter + "')";
...
Vvveb.Components.extend("_base", "widgets/browse", {
    name: "Browse",
    attributes: ["data-component-browse"],
    image: "icons/search.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/search.svg">',
    html: '<div data-component-browse><div onload></div></div>',
    resizable:true,//show select box resize handlers
    resizeMode:"css",
    ...
    tableName:'', //zoom
    column:'',//location
		id: '', //map type q = roadmap, w = satellite
	...
	init: function (node)
	{
		...
		$(".component-properties input[name=tableName]").val(this.tableName);
		$(".component-properties input[name=column]").val(this.column);
		$(".component-properties input[name=id]").val(this.id);
	},
    ...
    onChange: function (node, property, value) {
		...
		mapurl = "browsing(this,'" + this.tableName + "','" + this.column + "','" + this.id + "')";
...
*/
Vvveb.Components.extend("_base", "widgets/x", {
    name: "X",
    attributes: ["data-component-x"],
    image: "icons/twitter.svg",
    dragHtml: '<img src="' + Vvveb.baseUrl + 'icons/twitter.svg">',
    html: '<div data-component-x><iframe width="100%" height="100%"src="https://platform.x.com/embed/Tweet.html?embedId=x-widget-0&frame=false&hideCard=false&hideThread=false&id=943901463998169088"></iframe></div>',
    resizable:true,//show select box resize handlers
    resizeMode:"css",
    twitterRegex : /(?:x\.com(?:[^\d]+))(\d+)/i,
    ...
    onChange: function (node, property, value) {
		...
		if (property.key == "tweet") {
			...
			tweeturl = 'https://platform.x.com/embed/Tweet.html?embedId=x-widget-0&frame=false&hideCard=false&hideThread=false&id=' + this.tweet;
