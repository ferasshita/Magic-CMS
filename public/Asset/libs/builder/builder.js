...
//<head>
		...
		// self.frameHead.append('<link rel="stylesheet" href="' + Vvveb.baseUrl + '../../css/style.css" />');
		// self.frameHead.append('<link rel="stylesheet" type="text/css" href="' + Vvveb.baseUrl + '../../css/font-awesome-4.5.0/css/font-awesome.min.css">');
		//
		// self.frameHead.append('<link rel="stylesheet" href="' + Vvveb.baseUrl + '../../css/vendors_css.css">');
		// self.frameHead.append('<link rel="stylesheet" href="' + Vvveb.baseUrl + '../../css/style.css">');
		// self.frameHead.append('<link rel="stylesheet" href="' + Vvveb.baseUrl + '../../css/skin_color.css">');
		//
		// self.frameHead.append('<script src="' + Vvveb.baseUrl + '../../js_back/jquery.min.js"></script>');
		// self.frameHead.append('<script src="' + Vvveb.baseUrl + '../../js_back/jquery.form.min.js"></script>');
		// self.frameHead.append('<script src="' + Vvveb.baseUrl + '../../js_back/bootstrap.min.js"></script>');
		// self.frameHead.append('<script src="' + Vvveb.baseUrl + '../../js_back/code.js"></script>');
		// self.frameHead.append('<script type="text/javascript" src="' + Vvveb.baseUrl + '../../js_back/jquery.maxlength.js"></script>');
